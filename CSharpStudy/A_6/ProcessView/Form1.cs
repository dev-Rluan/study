...
namespace ProcessView
{
    public partial class Form1 : Form
    {
        ...
        private void ProccessKill()
        {
            try
            {
                ...
                else
                {
                  ...
                  "프로세스는 존재하지 않습니다", "알림", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ProcessView();
                }
            }
        ...
        {
            if (!(ProcessThread == null)) ProcessThread.Abort(); //스레드 종료
            if (!(checkThread == null)) checkThread.Abort(); //스레드 종료
        }
    }
}
